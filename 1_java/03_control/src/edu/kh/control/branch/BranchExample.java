...
public class BranchExample {
	...
	public void ex3() {
		...
		String str= ""; // 빈 문자열
						// 쌍 따옴표(" ") 라는 기호를 이용해 String 리터럴임을 지정
						// 하지만 내용이 없음
		...
		while(true) { // 무한 루프
			...
			if(input.equals("exit@")) {	
				...
				// String 자료형은 비교 연산자(==)로 같은 문자열인지 판별할 수없다.
				
				//★★★★ 비교 연산자는 보통 기본 자료형끼리의 연산에만 사용가능하다 ★★★★
				// -> String은 기본 자료형이 아닌 참초형
				
				// ** 해결 방법 : 문자열1.equals(문자열2) 으로 비교 가능하다 < 이건약속 외워야함** 
	...
	public void RPSGame() {
	   ...
	   for(int i=1; i<=round; i++) { // 입력 받은 판 수 만큼반복
		  ...
		  String com = null; // 컴퓨터가 선택한 가위/바위/보를 저장하는변수
		  //null : 아무것도 참조하고 있지않음
