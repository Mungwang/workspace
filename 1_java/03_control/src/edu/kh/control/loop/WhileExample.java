...
public class WhileExample {
	...
	public void ex1() {
		...
		while(input != 9) {
			...
			case 3 : System.out.println("삽겹살를 주문했습니다");break;
			case 9 : System.out.println("메뉴 선택을 종료합니다");
			
			default : System.out.println("잘못골랐어");break;
	...
	public void ex2() {
		...
		// 단,0이 입력되면 반복 종료 후 결과 출력
			// -> 0이 입력되지않으면 계속반복
		// 1) 조건이 안맞으면 한번도 실행안될수있음
		
		Scanner sc = new Scanner(System.in);
		
		
		int input=-1; // 입력 받은값을 저장할 변수
		
		// 1) 0이 아닌 값을 대입하여 while문이 처음에 수행될수 있도록한다
		
		int sum =0; // 모든정수의 합을 저장하는 변수
