...
public class ConditionExample {
	...
	public void ex3() {
		...
		if( input>0 ) { // input이 양수일 경우
			...
			// 바로 위에 있는 if문이 만족 되지않을 경우 수행
			System.out.println(" 음수 입니다");
		}else {
			// 모든 if, else if가 만족되자 않는 경우 수행
			System.out.println("0 입니다.");
	...
	public void ex4() {
		...
		String season; // 아래 조건문 수행결과를 지정할 변수 선언
		
		// 봄 : 3,4,5 여름 : 6,7,8 가을 : 9,10,11 겨울 : 12,1,2
		// 해당하는 게절이 없을 경우 "해당하는 계절이 없습니다." 출력
		
		if( month==3 || month==4 || month==5) { // 봄 : 3,4,5 여름
			season = "봄";
