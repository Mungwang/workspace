...
public class OpExample { // 예제 코드 작성용 클래스
	...
	public void ex2() {
		...
		System.out.printf("%d %% %d = %d\n", input1,input2,input1 % input2); // 나머지구할때는 %% 2개!
	...
	public void ex7() {
		...
		// a를 6으로 나눴을때 몫
		a /=6;
		System.out.println("a를 6으로 나누고 몫 : " + a); // 2
		
		// a를 2로 나눴을때 나머지
		a %=2;
		System.out.println("a를 2으로 나누고 나머지 : " + a); // 0
	...
	public void ex8() {
		...
		// num 값이 30을 초과하면 <str1> , num값이 30을 초과하지 못하면 str2를 
		// result 변수에 저장
