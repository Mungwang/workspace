...
public class Employee extends Person {
	...
	// Person으로 부터 상속 받은 메소드 중 move() 메소드를 Employee에 맞게 재정의(==오버라이딩)
	
	// @Override 어노테이션 : 해당메소스가 오버라이딩 되었음을 컴파일러에게 알려주는역할
	// 어노테이션(Annotation) : 컴파일러에게 알려주기 위한 코드 (컴파일러 인식용 주석)
	
	@Override // 오버라이딩 시 작성 해주는것이 좋다. ★★오버라이딩(쉽게말해 덮어쓰기)★★
	public void move() {
