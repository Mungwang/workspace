...
public class ScannerExample5 {
	...
	public static void main(String[] args) {
		...
		System.out.println(str); // next() : hello world = hello
							   // nextLine() : hello world 입력값 그대로
		...
		// ** next(), nextDouble(), nextInt()등 모두 입력 버퍼에서 (엔터)를 제외하고 내용만 읽어옴.
		...
		sc.nextLine(); // ★★★★★ 입력버퍼 : [  ] 습관적으로해야 입력버퍼 삭제가능 ★★★★★
		...
		// 다음 nextLine() 수행 시 버퍼에 남아있는 (엔터)를 읽어버러기 때문에
