...
//[접근제한자] [예약어] class 클래스명 - [ ] 생략가능 (  ) 무조건생략
	...
	// 클래스 변수(== static 변수) : 필드에 static 예약어가 작성딘 변수
	// why? 같은 클래스로 만들어진 객체가 값을 공유할 수 있기
	/*
	...
	public static String schoolName = "KH고등학교";
		//static =공전 
	private String name; // 캡슐화 원칙 때문에 private -> 간접 접근 방법필요
