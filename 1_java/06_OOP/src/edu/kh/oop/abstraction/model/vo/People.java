...
// VO (Value Object) : 값 저장용 객체를 만들기 위한 클래스 모아두는 패키지
...
public class People { // 국민(사람) 클래스
	...
	// -> 직접 접근을 못하기 때문에
	//    클래스 내부에 간접 접근방법을 제공하는 기능을 작성해둔다.
	...
	private String name;
	private char gender;
	private String pNo; // 123456-12345678(int타입은 -연산이된다)
	...
	// 캡슐화에서 사용할 간접 접근기능 (getter / setter)
	...
	public String getName() { // getter
		// 현재 객체의 속성 중 name을 호줄한 곳으로 반환(return)
		return name;
	}
