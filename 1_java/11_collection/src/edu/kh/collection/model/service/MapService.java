...
public class MapService {
	...
	// - Key를 모아두면 Set의 특징 ( 주머니모양 중복x )
	// - Value를 모아두면 List의 특징 ( 배열모양 중복o )
	...
	public void ex1() {
		...
		// Map.put(Integer Key, String Value) : 추가 ( put:놓다=추가한다)
		map.put(1, "홍길동");
		map.put(2, "고길동");
		map.put(3, "김길동");
		map.put(4, "박길동");
	...
	public void ex2() {
		...
		// value가 Object 타입 == 어떤 객체든 value에 들어올 수있다.
		...
		// 실행 중 확인해보니까 String 자식 객체 -> 자식 toString()호출 -> 동적 바인딩
		...
		// -> 이를 활용 할 수있도록 Map에서 KeySet()메소드를 제공
		// --> Key만 모아서 Set으로 반환
		...
		// map에 저장된 데이터가 많거나 , 어떤 Key가 있는지 불분명 할때
	...
	public void ex3() {
		...
		// for문 종료시 List에는 10개의 Map 객체가 추가 되어있다.
