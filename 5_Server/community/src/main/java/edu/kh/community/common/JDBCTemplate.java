...
public class JDBCTemplate {
	...
	public static Connection getConnection() {
		...
		try {
			...
			// JNDI(Java Naimg and Directory Interface API)
			// - 디렉토리에 접근하는 자용하는 Javaa API
			// - 애플리케이션(프로그램, 웹앱)은 JNDI를 이용해서 파일 또는 서버 Resource를 찾을수있음
			...
			// DECP 세팅의 <Resource> 태그를 찾아 DataSouce 형식의 객체로 얻어오기
