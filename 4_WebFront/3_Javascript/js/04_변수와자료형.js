...
console.log("num4 : " + num4); //fuction 종료 후에도 사용 가능

// console.log("num5 : " + num5); // error
console.log("num6 : " + num6); // function 내부 if문 종류 후에도 사용가능
...
function typeTest(){
    ...
    // 객체 내용 출력 방법 1
    typeBox.innerHTML += "<br>userid : " + user.id;
    typeBox.innerHTML += "<br>userpw : " + user.pw;
    ...
    console.log(user); // 콘솔 출력 시 보기 더좋음
