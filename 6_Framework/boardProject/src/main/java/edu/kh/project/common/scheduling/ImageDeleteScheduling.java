...
public class ImageDeleteScheduling {
	...
	//@Scheduled(cron ="0,30 * * * * *") // < 테스트할때 30초로 하고 ↓ 실제 쓸거
	@Scheduled(cron ="0 0 * * * *")
	public void test() {
