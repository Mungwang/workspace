...
-- user01의 비밀번호 변경
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$TRuZo8uRSx7Tw8GrRRGSO.MB1Y5ycnKTnEKTf0S0pJZc077MRRQM.';
...
-- 게시글 좋아요 샘플데이터 삽입
INSERT INTO BOARD_LIKE VALUES(1991,4);

COMMIT;

-- 특정 게시글의 좋아요 개수 카운트
SELECT COUNT(*) FROM BOARD_LIKE L
WHERE L.BOARD_NO = 1991;

-- 특정 게시글의 대한 이미지 조회(IMG_OREDR 오름차순)
...
VALUES(SEQ_IMG_NO.NEXTVAL,
    ...
    '202308211420_00002.jpg',
    'cat2.jpg',1,1991);

INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL,
    '/resources/images/board/',
    '202308211420_00003.jpg',
    'cat3.jpg',2,1991);
...
-- 회원 프로필 이미지 변경
UPDATE MEMBER SET
PROFILE_IMG = '/resources/images/member/4.gif'
WHERE MEMBER_NO =4;
...
VALUES(SEQ_COMMENT_NO.NEXTVAL,'부모 댓글 1', DEFAULT, DEFAULT, 1991, 4, NULL);

INSERT INTO "COMMENT"                                           -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL,'부모 댓글 2', DEFAULT, DEFAULT, 1991, 4, NULL);

INSERT INTO "COMMENT"                                           -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL,'자식 댓글 1-1', DEFAULT, DEFAULT, 1991, 4, 1010);

INSERT INTO "COMMENT"                                           -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL,'자식 댓글 1-2', DEFAULT, DEFAULT, 1991, 4, 1010);

INSERT INTO "COMMENT"                                           -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL,'자식 댓글 1-3', DEFAULT, DEFAULT, 1991, 4, 1010);

INSERT INTO "COMMENT"                                           -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL,'자식 댓글 2-1', DEFAULT, DEFAULT, 1991, 4, 1011);

INSERT INTO "COMMENT"                                           -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL,'자식 댓글 2-2', DEFAULT, DEFAULT, 1991, 4, 1011);

INSERT INTO "COMMENT"                                           -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL,'자식 댓글 2-1-1', DEFAULT, DEFAULT, 1991, 4, 1015);
...
-- 댓글 삽입
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '내용', 'pass01!'
	, '유저일', '01012341234', '06234,,서울 강남구 테헤란로 14길 6,,5층',
	NULL, DEFAULT, DEFAULT, DEFAULT);
